...
impl EnvConfig {
    ...
    pub fn load() -> Self {
        ...
        Self {
            ...
            couchdb_database: env::var("COUCHDB_DATABASE")
                .ok()
            ...
            iex_cloud_api_key: env::var("IEX_CLOUD_API_KEY")
                .ok()
            ...
            coinbase_secret_key: env::var("COINBASE_SECRET_KEY")
                .ok()
            ...
            max_retries: env::var("MAX_RETRIES").ok().and_then(|s| s.parse().ok()),
            ...
            export_batch_size: env::var("EXPORT_BATCH_SIZE")
                .ok()
                .and_then(|s| s.parse().ok()),
        }
    }
